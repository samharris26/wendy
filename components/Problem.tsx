  ...
  return (
    <section className="bg-surface px-6 py-20 lg:px-10">
      <div className="mx-auto w-full max-w-6xl">
        <div className="mx-auto max-w-3xl rounded-[22px] border border-primaryText/5 bg-card p-12 text-center shadow-[0_1px_2px_rgba(11,36,64,0.04)] md:p-20">
          <h2 className="text-3xl text-primaryText sm:text-4xl lg:text-5xl">
            Running a household shouldn&apos;t feel{" "}
            <em className="not-italic italic text-accent">chaotic.</em>
          </h2>
