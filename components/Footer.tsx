...
export function Footer() {
  return (
    <footer className="border-t border-border bg-background px-6 pb-12 pt-20 lg:px-10">
      {/* Top — Download CTA */}
      <div className="mx-auto flex w-full max-w-6xl flex-col items-start justify-between gap-12 border-b border-rule pb-16 md:flex-row md:items-center">
        <div className="max-w-lg">
          <p
            className="text-3xl italic text-accent md:text-4xl"
            style={{ fontFamily: 'Georgia, "Times New Roman", serif' }}
          >
            Noa
          </p>
          <p className="mt-4 text-lg leading-relaxed text-secondaryText">
            Your life, organised. Calendars, tasks, lists and reminders —
      ...
      {/* Link columns */}
      <div className="mx-auto mt-12 grid w-full max-w-6xl grid-cols-2 gap-8 border-b border-rule pb-12 sm:grid-cols-3 md:grid-cols-4">
        <div>
          <p className="mb-4 text-xs font-semibold uppercase tracking-wide text-primaryText">
            Features
          </p>
